package com.yadong.nike.passportConfig.interceptors;
...
public class AuthInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (StringUtils.isNotBlank(token)) {
            ...
            String ip = "127.0.0.1";
            String successJson = HttpclientUtil.doGet("http://localhost:9006/verify?token=" + token + "&currentIp=" + ip);
        ...
        if (loginSuccess) {
            ...
            if (!success.equals("success")) {
                ...
                response.sendRedirect("http://localhost:9006/index?ReturnUrl=" + requestURL);
                return false;
            }
